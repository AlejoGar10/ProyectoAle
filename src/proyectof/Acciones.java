...
public class Acciones extends javax.swing.JFrame {
    ...
    public Acciones() {
        ...
        jTextField1.setText(accion1.Tipo);
        
        Accion accion=new Accion();
        jTextField2.setText(accion.Dispo);
        
        Accion accion2=new Accion();
        jTextField3.setText(accion2.corr);
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Acciones del Dispositivo");
        ...
        jButton1.setText("Tomar Fotografia");
        ...
        jButton2.setText("Reproducir Musica");
        ...
        jButton5.setText("Compartir Documento");
        ...
        jButton6.setText("Recibir Documento");
        ...
        jLabel4.setText("Seleccionar la Accion que Desea Realizar con el Dispositivo");
        ...
        jButton9.setText("Recibir Llamadas");
        ...
        jButton10.setText("Ver Mensajes");
        ...
        jButton11.setText("Ver Notificaciones");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try {
          if( jTextField2.getText().equals(""))
                ...
                String  target="";
                String search="";
                String enc="Encendido";
                String searchs=jTextField3.getText();
                int x = 0;  int row=0;
                ...
                rdfile.close();
                    ...
                    for( int j=0; j < search.length(); j++)
                        ...
                        if( search.equals( target))
                            ...
                            if(searchs.equals(temps[2]))
                            if(enc.equals(temps[4]))
                                found=true;
                   }
                     if( !found){
                    JOptionPane.showMessageDialog(null, "Dispositivo no Vinculados", "ERROR", JOptionPane.ERROR_MESSAGE);
                     }else{
                          Fotos a= new Fotos ();
                          a.setVisible(true);
                          this.dispose();
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
       RecLlam a= new RecLlam ();
       a.setVisible(true);
       this.dispose();
    }//GEN-LAST:event_jButton9ActionPerformed

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
       VerMens a= new VerMens ();
       a.setVisible(true);
       this.dispose();
    }//GEN-LAST:event_jButton10ActionPerformed

    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
       VerNoti a= new VerNoti ();
       a.setVisible(true);
       this.dispose();
    }//GEN-LAST:event_jButton11ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
       Masiva2 a= new Masiva2 ();
       a.setVisible(true);
       this.dispose();
